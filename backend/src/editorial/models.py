...
class Article(WorkspaceRoot, Base):
    ...
    cover_media_id: Mapped[uuid.UUID | None] = mapped_column(ForeignKey("media_assets.id", ondelete="SET NULL", name="fk_articles_cover_media_id"), nullable=True)
...
class NewsItem(WorkspaceRoot, Base):
    ...
    body_markdown: Mapped[str | None] = mapped_column(Text, nullable=True)
    media_id: Mapped[uuid.UUID | None] = mapped_column(ForeignKey("media_assets.id", ondelete="SET NULL", name="fk_news_items_media_id"), nullable=True)
...
class CaseStudy(WorkspaceRoot, Base):
    ...
    before_media_id: Mapped[uuid.UUID | None] = mapped_column(ForeignKey("media_assets.id", ondelete="SET NULL", name="fk_case_studies_before_media_id"), nullable=True)
    after_media_id: Mapped[uuid.UUID | None] = mapped_column(ForeignKey("media_assets.id", ondelete="SET NULL", name="fk_case_studies_after_media_id"), nullable=True)
...
class Ebook(WorkspaceRoot, Base):
    ...
    category: Mapped[str | None] = mapped_column(Text, nullable=True)
    description: Mapped[str | None] = mapped_column(Text, nullable=True)
    cover_media_id: Mapped[uuid.UUID | None] = mapped_column(ForeignKey("media_assets.id", ondelete="SET NULL", name="fk_ebooks_cover_media_id"), nullable=True)
    download_media_id: Mapped[uuid.UUID | None] = mapped_column(ForeignKey("media_assets.id", ondelete="SET NULL", name="fk_ebooks_download_media_id"), nullable=True)
...
class QuizOption(WorkspaceRoot, Base):
    ...
    media_id: Mapped[uuid.UUID | None] = mapped_column(ForeignKey("media_assets.id", ondelete="SET NULL", name="fk_quiz_options_media_id"), nullable=True)
    position: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
